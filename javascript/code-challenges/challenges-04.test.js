...
const sortNames = (arr) => {
  return arr.sort((a, b) => {
    const firstCharA = a.charCodeAt(0);
    const firstCharB = b.charCodeAt(0);
...
const sortMeetingsByDay = (arr) => {
  return arr.sort((a, b) => {
    return dayOfWeekValue(a.dayOfWeek) - dayOfWeekValue(b.dayOfWeek);
  });
};
...
const sortSchedule = (arr) => {
  return arr.sort((a, b) => {
    const dayDifference = dayOfWeekValue(a.dayOfWeek) - dayOfWeekValue(b.dayOfWeek);
    if (dayDifference !== 0) {
      return dayDifference;
    }

    const startTimeDifference = parseInt(a.start, 10) - parseInt(b.start, 10);
    if (startTimeDifference !== 0) {
      return startTimeDifference;
    }

    const durationA = parseInt(a.end, 10) - parseInt(a.start, 10);
    const durationB = parseInt(b.end, 10) - parseInt(b.start, 10);
